...
public class AnnotationFileAdaptor extends BaseAdapter {
    String [] idResult;
    Context context;
    int [] imageId;
    List<AudioAnnotationFile> files;
    private static LayoutInflater inflater=null;
    public AnnotationFileAdaptor(ShowFilteredAnnotationActivity mainActivity, List<AudioAnnotationFile> annotatedFiles) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.tagAudio.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
